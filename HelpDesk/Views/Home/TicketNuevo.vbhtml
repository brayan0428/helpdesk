            ...
            <div Class="col-12">
                <div Class="card">
                    <div Class="card-block">
                        ...
                        <a href="@Url.Action("ExportarTicketsVerificados", "Home")" class="btn btn-success" style="float:right">Listado Tickets Verificados</a>
                            ...
                            <table class="tablesaw table-striped table-hover table-bordered table tablesaw-columntoggle" data-tablesaw-mode="columntoggle" id="table-2933"><!--ng-controller="TicketNuevo"-->
                                ...
                                <tbody>
                                    <tr ng-repeat="Fila in DataTable"> <!-- CodVerificacion -->
                                        ...
                                        <td>
                                            <a data-toggle="modal" href="#modal_long" data-ticket="{{Fila.CodTicket}}" data-necesidad="{{Fila.Necesidad}}" data-justificacion="{{Fila.Justificacion}}" data-adjunto="{{Fila.Adjunto}}" class="btn btn-info"
                                               onclick="EnviarDatos('Modal_ProcesarTicket', 'Home', 'Ticket Nro ' + $(this).attr('data-ticket'), 'modal_long', { 'CodTicket': $(this).attr('data-ticket'), 'Necesidad': $(this).attr('data-necesidad'), 'Justificacion': $(this).attr('data-justificacion'), 'Adjunto': $(this).attr('data-adjunto') })">{{Fila.CodTicket}}</a>
                                        </td>
