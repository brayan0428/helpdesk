                            ...
                            <table class="table color-table success-table">
                                ...
                                <tbody>
                                    <tr ng-repeat="dato in Tickets_Citados">
                                        <td>
                                            <button type="button" alt="default" data-toggle="modal" data-target=".bs-example-modal-sm" class="btn waves-effect waves-light btn-success model_img" ng-click="AsignarValTicket(dato.CodTicket,dato.Necesidad,dato.Justificacion)">{{dato.CodTicket}}</button>
                                        </td>
                                        <td>{{dato.Area}}</td>
